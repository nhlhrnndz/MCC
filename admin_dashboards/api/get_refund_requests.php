<?php
//MCC\admin_dashboards\api\get_refund_request.php
session_start();
...
try {
    $sql = "
        SELECT 
            ref.id, ref.refund_ref, ref.type, ref.refund_amount, ref.cancellation_fee,
            ref.reason, ref.status, ref.requested_at, ref.admin_notes,
